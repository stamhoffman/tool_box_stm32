 ...
 * mapping
  *     @arg GPIO_FullRemap_USART3       : USART3 Full Alternate Function
 * mapping
 ...
 * line devices)
  *     @arg GPIO_Remap_SWJ_NoJTRST      : Full SWJ Enabled (JTAG-DP + SW-DP)
 * but without JTRST
  *     @arg GPIO_Remap_SWJ_JTAGDisable  : JTAG-DP Disabled and SW-DP Enabled
  *     @arg GPIO_Remap_SWJ_Disable      : Full SWJ Disabled (JTAG-DP + SW-DP)
  *     @arg GPIO_Remap_SPI3             : SPI3/I2S3 Alternate Function mapping
 * (only for Connectivity line devices)
  *                                        When the SPI3/I2S3 is remapped using
 * this function, the SWJ is configured
  *                                        to Full SWJ Enabled (JTAG-DP + SW-DP)
 * but without JTRST.
  *     @arg GPIO_Remap_TIM2ITR1_PTP_SOF : Ethernet PTP output or USB OTG SOF
 * (Start of Frame) connected
  *                                        to TIM2 Internal Trigger 1 for
 * calibration (only for Connectivity line devices)
  *                                        If the GPIO_Remap_TIM2ITR1_PTP_SOF is
 * enabled the TIM2 ITR1 is connected to
  *                                        Ethernet PTP output. When Reset TIM2
 * ITR1 is connected to USB OTG SOF output.
 ...
 * (only for Value line devices)
  *     @arg GPIO_Remap_TIM16            : TIM16 Alternate Function mapping
 * (only for Value line devices)
  *     @arg GPIO_Remap_TIM17            : TIM17 Alternate Function mapping
 * (only for Value line devices)
 ...
 * remapping (only for High density Value line devices)
  *     @arg GPIO_Remap_TIM12            : TIM12 Alternate Function mapping
